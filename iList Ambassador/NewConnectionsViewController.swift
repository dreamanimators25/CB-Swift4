...
final class NewConnectionsViewController: UIViewController, FriendsTableViewCellDelegate1, FriendsTableViewCellDelegate2, SimpleDelegate {
    ...
    func removeGroup(cell: FriendsTableViewCell) {
            ...
            let alertController = UIAlertController(title: nil, message: "Do you want to remove this group?", preferredStyle: UIAlertControllerStyle.alert)
...
//                self.connectionRequests?.append(c)
    ...
    func showRemoveDialog(connection: Ambassadorship) {
        ...
        let alertController = UIAlertController(title: nil, message: "Do you want to opt out of the channel?", preferredStyle: UIAlertControllerStyle.alert)
