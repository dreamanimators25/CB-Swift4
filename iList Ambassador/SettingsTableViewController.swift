...
//    }
    ...
    fileprivate func promptOptOutUser() {
        let alertController = UIAlertController(title: NSLocalizedString("Do you really want to delete an account?", comment: ""), message: nil, preferredStyle: UIAlertControllerStyle.actionSheet)
        
        alertController.addAction(UIAlertAction(title:  NSLocalizedString("Yes", comment: ""), style: UIAlertActionStyle.destructive, handler: { (alertAction: UIAlertAction) in
            //self.reallyOut()
        ...
        alertController.addAction(UIAlertAction(title:  NSLocalizedString("No", comment: ""), style: UIAlertActionStyle.cancel, handler: { (alertAction: UIAlertAction) in
            alertController.dismiss(animated: true, completion: nil)
        }))
    ...
    fileprivate func reallyOut() {
        let alertController = UIAlertController(title: NSLocalizedString("Opting out will delete your profile and make all data generated in the system anonymized in agreement with the iList privacy policy and user agreement", comment: ""), message: nil, preferredStyle: UIAlertControllerStyle.actionSheet)
